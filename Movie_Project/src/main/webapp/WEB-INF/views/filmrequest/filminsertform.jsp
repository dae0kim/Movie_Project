...
<form action="<c:url value='/filmrequest/filminsertform'/>" method="post" enctype="multipart/form-data">
<table border="1">
<tr>
	<th>영화 제목</th>
	<td><input type="text" name="filmTitle" required></td>
</tr>
<tr>
	<th>개봉 날짜</th>
...
<tr>
	<th>상영 시간</th>
	<td><input type="number" name="runTime" min="1" max="999" required></td>
</tr>
<tr>
	<th>영화 장르</th>
	<td>
...
<tr>
	<th>주연 배우</th>
	<td><input type="text" name="mainActor" required></td>
</tr>
<tr>
	<th>조연 배우</th>
	<td><input type="text" name="subActor" required></td>
</tr>
<tr>
	<th>영화 줄거리</th>
	<td>
		<textarea name="summary" rows="5" cols="33" required>
		</textarea>
	</td>
</tr>
<tr>
