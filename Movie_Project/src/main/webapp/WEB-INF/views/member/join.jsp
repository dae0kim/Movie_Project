...
<!-- 							<label> 이메일</label> -->
						...
						<div>
<!-- 							<label >비밀번호</label> -->
							<input name="password" id="password" placeholder="비밀번호" type="password" size="15" oninput="passwordChk()" required>
						</div>						
						<div>
<!-- 							<label >비밀번호 확인</label> -->
...
<!-- 							<label>연락처</label> -->
						...
						<div class="confirm_reset_btn">			
							...
							<input type="submit" value="가입하기"  class="input_confirm_btn" onclick="join_btn_action()" >
							<a href="#close" rel="modal:close" ><input type="reset" value="취소" class="input_confirm_btn"></a>
